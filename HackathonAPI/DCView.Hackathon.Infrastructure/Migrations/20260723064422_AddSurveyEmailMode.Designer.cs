...
namespace DCView.Hackathon.Infrastructure.Migrations
{
    ...
    [Migration("20260723064422_AddSurveyEmailMode")]
    partial class AddSurveyEmailMode
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.Survey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Survey_Surveys");
                });

            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyDistribution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IncludeRm")
                        .HasColumnType("boolean");

                    b.Property<bool>("IncludeVh")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("Survey_Distributions");
                });

            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyEmailSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AdditionalCcEmails")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IncludeRmByDefault")
                        .HasColumnType("boolean");

                    b.Property<bool>("IncludeVhByDefault")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("Survey_EmailSettings");
                });

            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("MatrixColumns")
                        .HasColumnType("jsonb");

                    b.Property<string>("MatrixRows")
                        .HasColumnType("jsonb");
                    ...
                    b.ToTable("Survey_Fields");
                });

            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyFieldDependency", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Survey_FieldDependencies");
                });

            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyOtp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ParticipantId", "SurveyId");

                    b.ToTable("Survey_Otps");
                });

            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("VhEmail")
                        .HasMaxLength(300)
                        .HasColumnType("character varying(300)");

                    b.Property<string>("VhName")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("SurveyId", "EmployeeEmail");

                    b.ToTable("Survey_Participants");
                });

            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyParticipantStatusLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Survey_ParticipantStatusLogs");
                });

            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyReminderLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Survey_ReminderLogs");
                });

            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyResponseAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Survey_ResponseAnswers");
                });
            ...
            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.Survey", b =>
                {
                    b.HasOne("DCView.Hackathon.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyDistribution", b =>
                {
                    b.HasOne("DCView.Hackathon.Domain.Entities.SurveyParticipant", "Participant")
                        .WithOne("Distribution")
                        .HasForeignKey("DCView.Hackathon.Domain.Entities.SurveyDistribution", "ParticipantId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DCView.Hackathon.Domain.Entities.Survey", "Survey")
            ...
            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyEmailSettings", b =>
                {
                    b.HasOne("DCView.Hackathon.Domain.Entities.Survey", "Survey")
                        ...
                        .HasForeignKey("DCView.Hackathon.Domain.Entities.SurveyEmailSettings", "SurveyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyFieldDependency", b =>
                {
                    b.HasOne("DCView.Hackathon.Domain.Entities.SurveyField", "DependsOnField")
                        .WithMany("DependentFields")
                        .HasForeignKey("DependsOnFieldId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("DCView.Hackathon.Domain.Entities.SurveyField", "Field")
            ...
            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyParticipantStatusLog", b =>
                {
                    b.HasOne("DCView.Hackathon.Domain.Entities.User", "MarkedByUser")
                        .WithMany()
                    ...
                    b.HasOne("DCView.Hackathon.Domain.Entities.SurveyParticipant", "Participant")
                        .WithOne("StatusLog")
                        .HasForeignKey("DCView.Hackathon.Domain.Entities.SurveyParticipantStatusLog", "ParticipantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyReminderLog", b =>
                {
                    b.HasOne("DCView.Hackathon.Domain.Entities.SurveyDistribution", "Distribution")
                        .WithMany("Reminders")
            ...
            modelBuilder.Entity("DCView.Hackathon.Domain.Entities.SurveyResponseAnswer", b =>
                {
                    ...
                    b.HasOne("DCView.Hackathon.Domain.Entities.SurveyResponse", "Response")
                        .WithMany("Answers")
